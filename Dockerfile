...
COPY ovn22.06-22.06.0-preview.6.el8fdp.x86_64.rpm ovn22.06-central-22.06.0-preview.6.el8fdp.x86_64.rpm ovn22.06-host-22.06.0-preview.6.el8fdp.x86_64.rpm ovn22.06-vtep-22.06.0-preview.6.el8fdp.x86_64.rpm /root/
COPY openvswitch2.17-2.17.0-20.el8fdp.x86_64.rpm  openvswitch2.17-devel-2.17.0-20.el8fdp.x86_64.rpm  openvswitch2.17-ipsec-2.17.0-20.el8fdp.x86_64.rpm  python3-openvswitch2.17-2.17.0-20.el8fdp.x86_64.rpm /root/
...
RUN INSTALL_PKGS=" \
	...
	rpm -e ovn22.03 ovn22.03-central ovn22.03-host ovn22.03-vtep && \
	rpm -e openvswitch2.17 openvswitch2.17-devel python3-openvswitch2.17 openvswitch2.17-ipsec && \
	rpm -Uhv /root/ovn22.06* && \
	rpm -Uhv /root/*openvswitch2.17* && \
