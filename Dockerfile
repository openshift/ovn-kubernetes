...
RUN INSTALL_PKGS=" \
	...
	yum install -y --setopt=tsflags=nodocs --setopt=skip_missing_names_on_install=False "openvswitch2.13 == 2.13.0-52.el8fdp" "openvswitch2.13-devel == 2.13.0-52.el8fdp" && \
