...
COPY ovn-2021-21.03.0-31.el8fdp.x86_64.rpm ovn-2021-central-21.03.0-31.el8fdp.x86_64.rpm ovn-2021-host-21.03.0-31.el8fdp.x86_64.rpm ovn-2021-vtep-21.03.0-31.el8fdp.x86_64.rpm /root/
...
RUN INSTALL_PKGS=" \
	...
	rpm -Uhv --force --nodeps /root/ovn-2021*.rpm && \
