...
COPY openvswitch2.13-2.13.0-67.el8fdp.x86_64.rpm openvswitch2.13-devel-2.13.0-67.el8fdp.x86_64.rpm /root/

RUN yum install -y /root/openvswitch*.rpm

RUN rm -f /root/openvswitch*.rpm
