...
COPY openvswitch2.16-2.16.0-22.el8fdp.x86_64.rpm openvswitch2.16-devel-2.16.0-22.el8fdp.x86_64.rpm openvswitch2.16-ipsec-2.16.0-22.el8fdp.x86_64.rpm python3-openvswitch2.16-2.16.0-22.el8fdp.x86_64.rpm /root/
