...
COPY ovn21.09-21.09.0-18.el8fdp.x86_64.rpm ovn21.09-central-21.09.0-18.el8fdp.x86_64.rpm ovn21.09-host-21.09.0-18.el8fdp.x86_64.rpm ovn21.09-vtep-21.09.0-18.el8fdp.x86_64.rpm /root
...
RUN INSTALL_PKGS=" \
    ...
    rpm -Uhv --force --nodeps /root/ovn21.09*.rpm && \
