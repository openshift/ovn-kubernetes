...
COPY ovn22.03-22.03.0-gw_router_lb.27.el8fdp.x86_64.rpm ovn22.03-central-22.03.0-gw_router_lb.27.el8fdp.x86_64.rpm ovn22.03-host-22.03.0-gw_router_lb.27.el8fdp.x86_64.rpm ovn22.03-vtep-22.03.0-gw_router_lb.27.el8fdp.x86_64.rpm /root/
COPY openvswitch2.17-2.17.0-8.el8fdp.x86_64.rpm openvswitch2.17-devel-2.17.0-16.el8fdp.x86_64.rpm openvswitch2.17-devel-2.17.0-8.el8fdp.x86_64.rpm openvswitch2.17-ipsec-2.17.0-8.el8fdp.x86_64.rpm /root/
...
RUN INSTALL_PKGS=" \
	...
	checkpolicy kmod libpkgconf numactl-libs openvswitch-selinux-extra-policy pkgconf pkgconf-m4 pkgconf-pkg-config policycoreutils-python-utils python3-audit python3-libselinux python3-libsemanage python3-policycoreutils python3-setools selinux-policy-targeted \
	" && \
