...
COPY ovn2.13-central-debuginfo-20.12.0-24.el8fdp.x86_64.rpm ovn2.13-debuginfo-20.12.0-24.el8fdp.x86_64.rpm ovn2.13-debugsource-20.12.0-24.el8fdp.x86_64.rpm ovn2.13-host-debuginfo-20.12.0-24.el8fdp.x86_64.rpm /root
...
RUN INSTALL_PKGS=" \
	...
	rpm -Uvh --force --nodeps /root/ovn2.13*.rpm && \
