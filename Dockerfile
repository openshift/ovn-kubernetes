...
COPY openvswitch2.15-2.15.0-2.el8fdp.x86_64.rpm openvswitch2.15-devel-2.15.0-2.el8fdp.x86_64.rpm openvswitch2.15-ipsec-2.15.0-2.el8fdp.x86_64.rpm python3-openvswitch2.15-2.15.0-2.el8fdp.x86_64.rpm /root/
