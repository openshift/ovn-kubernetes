...
# Or run ovnkube-master-cluster-manager-nc-manager deployment.
kubectl create -f $HOME/work/src/github.com/ovn-org/ovn-kubernetes/dist/yaml/ovnkube-master-cluster-manager-nc-manager.yaml
