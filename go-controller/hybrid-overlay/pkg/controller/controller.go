...
func StartHybridOverlay(ctx *cli.Context, master bool, nodeName string,
	clientset kubernetes.Interface, wf *factory.WatchFactory,
	...
	if master {
		...
		if err := masterController.Start(wf, stopChan); err != nil {
			return err
		}
	}
	...
	if nodeName != "" {
		...
		if err := nodeController.Start(wf, stopChan); err != nil {
			return err
		}
	}
