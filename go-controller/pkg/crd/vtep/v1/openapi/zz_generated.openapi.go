...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		v1.VTEPStatus{}.OpenAPIModelName():                                schema_pkg_crd_vtep_v1_VTEPStatus(ref),
...
func schema_pkg_crd_vtep_v1_VTEP(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VTEP defines VTEP (VXLAN Tunnel Endpoint) IP configuration for EVPN.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref(v1.VTEPSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref(v1.VTEPStatus{}.OpenAPIModelName()),
						},
					},
				},
		...
		Dependencies: []string{
			v1.VTEPSpec{}.OpenAPIModelName(), v1.VTEPStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_vtep_v1_VTEPList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VTEPList contains a list of VTEP.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1.VTEP{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1.VTEP{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_vtep_v1_VTEPSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VTEPSpec defines the desired state of VTEP.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"cidrs": {
					...
					"mode": {
						SchemaProps: spec.SchemaProps{
							Description: "Mode specifies how VTEP IPs are managed. \"Managed\" means OVN-Kubernetes allocates and assigns VTEP IPs per node automatically. \"Unmanaged\" means an external provider handles IP assignment; OVN-Kubernetes discovers existing IPs on nodes. Defaults to \"Managed\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_crd_vtep_v1_VTEPStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VTEPStatus contains the observed state of the VTEP.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							Description: "Conditions slice of condition objects indicating details about VTEP status.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
