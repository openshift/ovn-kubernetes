...
- name: com.github.ovn-kubernetes.ovn-kubernetes.go-controller.pkg.crd.clusternetworkconnect.v1.ClusterNetworkConnect
  map:
    fields:
    - name: apiVersion
      type:
    ...
    - name: spec
      type:
        namedType: com.github.ovn-kubernetes.ovn-kubernetes.go-controller.pkg.crd.clusternetworkconnect.v1.ClusterNetworkConnectSpec
      default: {}
    - name: status
      type:
        namedType: com.github.ovn-kubernetes.ovn-kubernetes.go-controller.pkg.crd.clusternetworkconnect.v1.ClusterNetworkConnectStatus
      default: {}
- name: com.github.ovn-kubernetes.ovn-kubernetes.go-controller.pkg.crd.clusternetworkconnect.v1.ClusterNetworkConnectSpec
  map:
    fields:
    - name: connectSubnets
      type:
        list:
          elementType:
            namedType: com.github.ovn-kubernetes.ovn-kubernetes.go-controller.pkg.crd.clusternetworkconnect.v1.ConnectSubnet
    ...
    - name: networkSelectors
      type:
        list:
          ...
          elementRelationship: atomic
- name: com.github.ovn-kubernetes.ovn-kubernetes.go-controller.pkg.crd.clusternetworkconnect.v1.ClusterNetworkConnectStatus
  map:
    fields:
    - name: conditions
      type:
    ...
    - name: status
      type:
        scalar: string
- name: com.github.ovn-kubernetes.ovn-kubernetes.go-controller.pkg.crd.clusternetworkconnect.v1.ConnectSubnet
  map:
    fields:
    - name: cidr
      type:
