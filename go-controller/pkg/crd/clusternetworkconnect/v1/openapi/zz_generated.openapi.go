...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		v1.ClusterNetworkConnect{}.OpenAPIModelName():                     schema_pkg_crd_clusternetworkconnect_v1_ClusterNetworkConnect(ref),
		v1.ClusterNetworkConnectList{}.OpenAPIModelName():                 schema_pkg_crd_clusternetworkconnect_v1_ClusterNetworkConnectList(ref),
...
func schema_pkg_crd_clusternetworkconnect_v1_ClusterNetworkConnect(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterNetworkConnect enables connecting multiple User Defined Networks and/or Cluster User Defined Networks together.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1.ClusterNetworkConnectSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1.ClusterNetworkConnectStatus{}.OpenAPIModelName()),
						},
					},
				},
		...
		Dependencies: []string{
			v1.ClusterNetworkConnectSpec{}.OpenAPIModelName(), v1.ClusterNetworkConnectStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_clusternetworkconnect_v1_ClusterNetworkConnectList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterNetworkConnectList contains a list of ClusterNetworkConnect.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1.ClusterNetworkConnect{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1.ClusterNetworkConnect{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_clusternetworkconnect_v1_ClusterNetworkConnectSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"networkSelectors": {
						SchemaProps: spec.SchemaProps{
							Description: "networkSelectors selects the networks to be connected together. This can match User Defined Networks (UDNs) and/or Cluster User Defined Networks (CUDNs). Only ClusterUserDefinedNetworkSelector and PrimaryUserDefinedNetworkSelector can be selected.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"connectSubnets": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1.ConnectSubnet{}.OpenAPIModelName()),
									},
								},
							},
						},
					...
					"connectivity": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "connectivity specifies which connectivity types should be enabled for the connected networks.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_crd_clusternetworkconnect_v1_ClusterNetworkConnectStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterNetworkConnectStatus defines the observed state of ClusterNetworkConnect.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "status is a concise indication of whether the ClusterNetworkConnect resource is applied with success.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "conditions is an array of condition objects indicating details about status of ClusterNetworkConnect object.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_crd_clusternetworkconnect_v1_ConnectSubnet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"cidr": {
						SchemaProps: spec.SchemaProps{
							Description: "CIDR specifies ConnectSubnet, which is split into smaller subnets for every connected network. This CIDR should be containing 2*((Number of L3 networks*Max Number of Nodes)+Number of L2 networks) IPs. Example: cidr= \"192.168.0.0/16\", networkPrefix=24 and if the cluster has 128 nodes that means that you can connect 256 layer3 networks and 0 layer2 networks OR 255 layer3 networks and 128 layer2 networks.\n\nCIDR also restricts the maximum number of networks that can be connected together based on what CIDR range is picked. So choosing a large enough CIDR for future use cases is important.\n\nThe largest CIDR that can be used for this field is /16 (65536 IPs) because OVN has a limit of 32K(2^15) tunnel keys per router. So we will only ever have 32K /31 or /127 slices which is 2^16 IPs. Having a CIDR greater than /16 will not be utilized fully for the same reason.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"networkPrefix": {
						SchemaProps: spec.SchemaProps{
							Description: "NetworkPrefix specifies the prefix length for every connected network. This prefix length should be strictly longer than the length of the CIDR prefix.\n\nFor example, if the CIDR is 10.0.0.0/16 and the networkPrefix is 24, then the connect subnet for each connected layer3 network will be 10.0.0.0/24, 10.0.1.0/24, 10.0.2.0/24 etc.\n\nFor layer2 networks we will allocate the next available /networkPrefix range that is then split into /31 or /127 slices for each layer2 network A good practice is to set this to a value that ensures it contains more than twice the number of maximum nodes planned to be deployed in the cluster. Each node gets a /31 subnet for the layer3 networks, hence networkPrefix should contain enough IPs for 4 times the maximum nodes planned Example - recommended values: if you plan to deploy 10 nodes, set the networkPrefix to /26 (40+ IPs) if you plan to deploy 100 nodes, set the networkPrefix to /23 (400+ IPs) if you plan to deploy 1000 nodes, set the networkPrefix to /20 (4000+ IPs) if you plan to deploy 5000 nodes, set the networkPrefix to /17 (20000+ IPs) This field restricts the maximum number of nodes that can be deployed in the cluster and hence its good to plan this value carefully along with the CIDR.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
