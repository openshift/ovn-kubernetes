...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/udnnode/v1/apis/clientset/versioned/scheme"
...
func (c *K8sV1Client) UDNNodes() UDNNodeInterface {
	return newUDNNodes(c)
}
