...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		v1alpha1.Bandwidth{}.OpenAPIModelName():                        schema_pkg_crd_networkqos_v1alpha1_Bandwidth(ref),
		v1alpha1.Classifier{}.OpenAPIModelName():                       schema_pkg_crd_networkqos_v1alpha1_Classifier(ref),
		v1alpha1.Destination{}.OpenAPIModelName():                      schema_pkg_crd_networkqos_v1alpha1_Destination(ref),
		v1alpha1.NetworkQoS{}.OpenAPIModelName():                       schema_pkg_crd_networkqos_v1alpha1_NetworkQoS(ref),
		v1alpha1.NetworkQoSList{}.OpenAPIModelName():                   schema_pkg_crd_networkqos_v1alpha1_NetworkQoSList(ref),
		v1alpha1.Port{}.OpenAPIModelName():                             schema_pkg_crd_networkqos_v1alpha1_Port(ref),
		v1alpha1.Rule{}.OpenAPIModelName():                             schema_pkg_crd_networkqos_v1alpha1_Rule(ref),
		v1alpha1.Spec{}.OpenAPIModelName():                             schema_pkg_crd_networkqos_v1alpha1_Spec(ref),
		v1alpha1.Status{}.OpenAPIModelName():                           schema_pkg_crd_networkqos_v1alpha1_Status(ref),
...
func schema_pkg_crd_networkqos_v1alpha1_Bandwidth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Bandwidth controls the maximum of rate traffic that can be sent or received on the matching packets.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"rate": {
						SchemaProps: spec.SchemaProps{
							Description: "rate The value of rate limit in kbps. Traffic over the limit will be dropped.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"burst": {
						SchemaProps: spec.SchemaProps{
							Description: "burst The value of burst rate limit in kilobits. This also needs rate to be specified.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
...
func schema_pkg_crd_networkqos_v1alpha1_Classifier(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"to": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.Destination{}.OpenAPIModelName()),
									},
								},
							},
						},
					...
					"ports": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.Port{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.Destination{}.OpenAPIModelName(), v1alpha1.Port{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_networkqos_v1alpha1_Destination(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Destination describes a peer to apply NetworkQoS configuration for the outgoing traffic. Only certain combinations of fields are allowed.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"podSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "podSelector is a label selector which selects pods. This field follows standard label selector semantics; if present but empty, it selects all pods.\n\nIf namespaceSelector is also set, then the NetworkQoS as a whole selects the pods matching podSelector in the Namespaces selected by NamespaceSelector. Otherwise it selects the pods matching podSelector in the NetworkQoS's own namespace.",
							Ref:         ref(metav1.LabelSelector{}.OpenAPIModelName()),
						},
					},
					"namespaceSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "namespaceSelector selects namespaces using cluster-scoped labels. This field follows standard label selector semantics; if present but empty, it selects all namespaces.\n\nIf podSelector is also set, then the NetworkQoS as a whole selects the pods matching podSelector in the namespaces selected by namespaceSelector. Otherwise it selects all pods in the namespaces selected by namespaceSelector.",
							Ref:         ref(metav1.LabelSelector{}.OpenAPIModelName()),
						},
					},
					"ipBlock": {
...
func schema_pkg_crd_networkqos_v1alpha1_NetworkQoS(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NetworkQoS is a CRD that allows the user to define a DSCP marking and metering for pods ingress/egress traffic on its namespace to specified CIDRs, protocol and port. Traffic belong these pods will be checked against each Rule in the namespace's NetworkQoS, and if there is a match the traffic is marked with relevant DSCP value and enforcing specified policing parameters.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.Spec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.Status{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1alpha1.Spec{}.OpenAPIModelName(), v1alpha1.Status{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_networkqos_v1alpha1_NetworkQoSList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NetworkQoSList contains a list of NetworkQoS",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.NetworkQoS{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.NetworkQoS{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_networkqos_v1alpha1_Port(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Port specifies destination protocol and port on which NetworkQoS rule is applied",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"protocol": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_crd_networkqos_v1alpha1_Rule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"classifier": {
						SchemaProps: spec.SchemaProps{
							Description: "classifier The classifier on which packets should match to apply the NetworkQoS Rule. This field is optional, and in case it is not set the rule is applied to all egress traffic regardless of the destination.",
							Default:     map[string]interface{}{},
							Ref:         ref(v1alpha1.Classifier{}.OpenAPIModelName()),
						},
					},
					"bandwidth": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.Bandwidth{}.OpenAPIModelName()),
						},
					},
				},
				Required: []string{"dscp"},
			},
		},
		Dependencies: []string{
			v1alpha1.Bandwidth{}.OpenAPIModelName(), v1alpha1.Classifier{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_networkqos_v1alpha1_Spec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"networkSelectors": {
						SchemaProps: spec.SchemaProps{
							Description: "networkSelector selects the networks on which the pod IPs need to be added to the source address set. NetworkQoS controller currently supports `NetworkAttachmentDefinitions` type only.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"podSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "podSelector applies the NetworkQoS rule only to the pods in the namespace whose label matches this definition. This field is optional, and in case it is not set results in the rule being applied to all pods in the namespace.",
							Default:     map[string]interface{}{},
							Ref:         ref(metav1.LabelSelector{}.OpenAPIModelName()),
						},
					},
					"priority": {
						SchemaProps: spec.SchemaProps{
							Description: "priority is a value from 0 to 100 and represents the NetworkQoS' priority. QoSes with numerically higher priority takes precedence over those with lower.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"egress": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "egress a collection of Egress NetworkQoS rule objects. A total of 20 rules will be allowed in each NetworkQoS instance. The relative precedence of egress rules within a single NetworkQos object (all of which share the priority) will be determined by the order in which the rule is written. Thus, a rule that appears first in the list of egress rules would take the lower precedence.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
				...
				Required: []string{"priority", "egress"},
			},
		},
		Dependencies: []string{
			v1alpha1.Rule{}.OpenAPIModelName(), types.NetworkSelector{}.OpenAPIModelName(), metav1.LabelSelector{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_networkqos_v1alpha1_Status(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "A concise indication of whether the NetworkQoS resource is applied with success.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "An array of condition objects indicating details about status of NetworkQoS object.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
