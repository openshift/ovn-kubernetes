...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		v1alpha1.UplinkNodeConfig{}.OpenAPIModelName():                 schema_pkg_crd_uplink_v1alpha1_UplinkNodeConfig(ref),
		v1alpha1.UplinkSpec{}.OpenAPIModelName():                       schema_pkg_crd_uplink_v1alpha1_UplinkSpec(ref),
		v1alpha1.UplinkState{}.OpenAPIModelName():                      schema_pkg_crd_uplink_v1alpha1_UplinkState(ref),
		v1alpha1.UplinkStateList{}.OpenAPIModelName():                  schema_pkg_crd_uplink_v1alpha1_UplinkStateList(ref),
		v1alpha1.UplinkStateSpec{}.OpenAPIModelName():                  schema_pkg_crd_uplink_v1alpha1_UplinkStateSpec(ref),
		v1alpha1.UplinkStateStatus{}.OpenAPIModelName():                schema_pkg_crd_uplink_v1alpha1_UplinkStateStatus(ref),
		v1alpha1.UplinkStatus{}.OpenAPIModelName():                     schema_pkg_crd_uplink_v1alpha1_UplinkStatus(ref),
...
func schema_pkg_crd_uplink_v1alpha1_OVSBridgeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the resolved OVS bridge used for OVN bridge mappings and flows.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_crd_uplink_v1alpha1_Uplink(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Uplink represents a physical network path out of a node that OVN-Kubernetes can connect its logical topology to. Supported node config type: OVSBridge.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.UplinkSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.UplinkStatus{}.OpenAPIModelName()),
						},
					},
				},
		...
		Dependencies: []string{
			v1alpha1.UplinkSpec{}.OpenAPIModelName(), v1alpha1.UplinkStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_uplink_v1alpha1_UplinkList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UplinkList contains a list of Uplink resources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.Uplink{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.Uplink{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_uplink_v1alpha1_UplinkNodeConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "Type is the uplink node config type. Supported value: OVSBridge.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"nodeSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "NodeSelector selects nodes where this uplink config applies. An empty selector matches all nodes.",
							Default:     map[string]interface{}{},
							Ref:         ref(metav1.LabelSelector{}.OpenAPIModelName()),
						},
					},
					"hostInterfaceName": {
						SchemaProps: spec.SchemaProps{
							Description: "HostInterfaceName is the host-visible Linux interface that carries the gateway L3 identity for this uplink. In non-accelerated deployments, this is typically the OVS bridge Linux interface, whose name usually matches the OVS bridge name. In SmartNIC accelerated deployments, this is the VF/SF netdevice and OVN-Kubernetes resolves the OVS bridge through its representor. In DPU deployments, this is the DPU-host PF interface whose DPU-side PF representor is attached to the OVS bridge.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"type", "nodeSelector", "hostInterfaceName"},
			},
		},
		Dependencies: []string{
			metav1.LabelSelector{}.OpenAPIModelName()},
...
func schema_pkg_crd_uplink_v1alpha1_UplinkSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"nodeConfigs": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "NodeConfigs contains mappings of nodes to uplink configuration. A node may be selected by at most one nodeConfig entry. Multiple nodeConfigs that select the same node are treated as a configuration error.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.UplinkNodeConfig{}.OpenAPIModelName()),
									},
								},
							},
						},
				...
				Required: []string{"nodeConfigs"},
			},
		},
		Dependencies: []string{
			v1alpha1.UplinkNodeConfig{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_uplink_v1alpha1_UplinkState(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UplinkState contains node-local discovery and gateway state for an Uplink.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.UplinkStateSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.UplinkStateStatus{}.OpenAPIModelName()),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			v1alpha1.UplinkStateSpec{}.OpenAPIModelName(), v1alpha1.UplinkStateStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_uplink_v1alpha1_UplinkStateList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "UplinkStateList contains a list of UplinkState resources.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.UplinkState{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.UplinkState{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_crd_uplink_v1alpha1_UplinkStateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"uplinkName": {
						SchemaProps: spec.SchemaProps{
							Description: "UplinkName is the Uplink this state belongs to.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"nodeName": {
						SchemaProps: spec.SchemaProps{
							Description: "NodeName is the node this state belongs to.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"uplinkName", "nodeName"},
			},
		},
	}
}

func schema_pkg_crd_uplink_v1alpha1_UplinkStateStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "Type is defined by the matched nodeConfig of the Uplink.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"hostInterfaceName": {
						SchemaProps: spec.SchemaProps{
							Description: "HostInterfaceName is the host-visible Linux interface selected by Uplink spec. It carries the host-side gateway L3 identity in all modes.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"ovsBridge": {
						SchemaProps: spec.SchemaProps{
							Description: "OVSBridge contains resolved OVS bridge data.",
							Ref:         ref(v1alpha1.OVSBridgeStatus{}.OpenAPIModelName()),
						},
					},
					"macAddress": {
						SchemaProps: spec.SchemaProps{
							Description: "MACAddress is the MAC address used for the OVN gateway interface.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"ipAddresses": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "IPAddresses are host-side shared gateway IP addresses.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Conditions reports node-local discovery and gateway programming state for this resolved uplink.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_crd_uplink_v1alpha1_UplinkStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Conditions reports aggregate Uplink state.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
