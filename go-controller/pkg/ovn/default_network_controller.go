...
func (oc *DefaultNetworkController) Run(ctx context.Context) error {
	...
	if config.OVNKubernetesFeature.EnableEgressFirewall {
		...
		if config.OVNKubernetesFeature.EnableDNSNameResolver {
			oc.dnsNameResolver, err = dnsnameresolver.NewExternalEgressDNS(oc.addressSetFactory, oc.controllerName, true, oc.watchFactory.DNSNameResolverInformer().Informer())
		} else {
