...
type Controller struct {
	...
	egressGWCache      map[ktypes.NamespacedName]*externalRouteInfo
	egressGWCacheMutex sync.RWMutex
...
func NewOvnController(ovnClient *util.OVNClientset, wf *factory.WatchFactory,
	...
	return &Controller{
		...
		namespacesMutex:           sync.Mutex{},
		egressGWCache:             make(map[ktypes.NamespacedName]*externalRouteInfo),
		egressGWCacheMutex:        sync.RWMutex{},
