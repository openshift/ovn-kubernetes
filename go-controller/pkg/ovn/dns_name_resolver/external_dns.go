...
func NewExternalEgressDNS(addressSetFactory addressset.AddressSetFactory, controllerName string, ignoreClusterSubnet bool, dnsSharedIndexInformer cache.SharedIndexInformer) (*ExternalEgressDNS, error) {
