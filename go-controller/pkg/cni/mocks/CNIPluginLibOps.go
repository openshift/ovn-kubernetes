...
// SetupVethWithName provides a mock function with given fields: contVethName, hostVethName, mtu, hostNS
func (_m *CNIPluginLibOps) SetupVethWithName(contVethName, hostVethName string, mtu int, hostNS ns.NetNS) (net.Interface, net.Interface, error) {
