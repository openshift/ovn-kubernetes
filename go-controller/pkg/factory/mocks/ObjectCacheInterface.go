...
type mockConstructorTestingTNewObjectCacheInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewObjectCacheInterface(t mockConstructorTestingTNewObjectCacheInterface) *ObjectCacheInterface {
