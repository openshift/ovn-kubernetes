...
func TestReconcileUplinkSource(t *testing.T) {
	...
	// prime a designation so hasUnknownSource is only true if it gets invalidated.
	c.setMacBindingSourceForUplinks(map[string]string{"uplinkA": "rtoe-GR_stale_node1"})
