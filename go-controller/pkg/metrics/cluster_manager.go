...
var registerClusterManagerMetrics sync.Once

// MetricClusterManagerLeader identifies whether this instance of cluster manager is a leader or not
...
func RegisterClusterManagerFunctional() {
	registerClusterManagerMetrics.Do(func() {
