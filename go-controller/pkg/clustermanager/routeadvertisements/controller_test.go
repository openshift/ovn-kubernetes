...
func TestController_reconcile(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			eips: []*testEIP{
				{Name: "eip1", EIPs: map[string]string{"node": "172.100.0.16"}, NamespaceSelector: map[string]string{"selected": "blue"}}, // secondary interface EIP, ignored
			...
			expectFRRConfigs: []*testFRRConfig{
				{
					...
					NodeSelector: map[string]string{"kubernetes.io/hostname": "node"},
					Routers: []*testRouter{
						{ASN: 1, VRF: "red", Prefixes: []string{"1.0.1.3/32"}, Neighbors: []*testNeighbor{
							{ASN: 1, Address: "1.0.0.100", Advertise: []string{"1.0.1.3/32"}},
						}},
					}},
			},
