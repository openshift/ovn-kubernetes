...
// MarshalPodDPUConnDetails updates the given pod annotation with a JSON-formatted annotation describing
// the pod's DPU connection details
...
// MarshalPodDPUConnStatus updates the given pod annotation with a JSON-formatted annotation describing
// the pod's DPU connection status
