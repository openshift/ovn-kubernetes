...
ovn_hybrid_overlay_enable=${OVN_HYBRID_OVERLAY_ENABLE:${OVN_EXTENSIONS_ENABLE:-}}
ovn_hybrid_overlay_net_cidr=${OVN_HYBRID_OVERLAY_NET_CIDR:${OVN_EXTENSIONS_NET_CIDR:-}}
