...
var Annotations = map[string]string{
	...
	"BGP: Pod to external server when CUDN network is advertised Route Advertisements layer2": "[Suite:openshift/conformance/parallel]",

	"BGP: Pod to external server when CUDN network is advertised Route Advertisements layer3": "[Suite:openshift/conformance/parallel]",

	"BGP: Pod to external server when default podNetwork is advertised when a client ovnk pod targeting an external server is created tests are run towards the external agnhost echo server": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks host to a different node UDN pod should not work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks host to a local UDN pod should not work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod in the UDN should be able to access a service in the same network": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod in the UDN should be able to access kapi in default network service": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod in the UDN should not be able to access a default network service": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod in the UDN should not be able to access a service in a different UDN": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod in the default network should not be able to access a UDN service": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod in the default network should not be able to access an advertised UDN pod on a different node": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod in the default network should not be able to access an advertised UDN pod on the same node": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod to pod on different networks and different nodes should not work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod to pod on different networks and same node should not work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod to pod on the same network and different nodes should work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer2 connectivity between networks pod to pod on the same network and same node should work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks host to a different node UDN pod should not work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks host to a local UDN pod should not work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod in the UDN should be able to access a service in the same network": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod in the UDN should be able to access kapi in default network service": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod in the UDN should not be able to access a default network service": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod in the UDN should not be able to access a service in a different UDN": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod in the default network should not be able to access a UDN service": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod in the default network should not be able to access an advertised UDN pod on a different node": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod in the default network should not be able to access an advertised UDN pod on the same node": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod to pod on different networks and different nodes should not work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod to pod on different networks and same node should not work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod to pod on the same network and different nodes should work": "[Suite:openshift/conformance/parallel]",

	"BGP: isolation between advertised networks Layer3 connectivity between networks pod to pod on the same network and same node should work": "[Suite:openshift/conformance/parallel]",
	...
	"External Gateway With Admin Policy Based External Route CRs e2e multiple external gateway stale conntrack entry deletion validation Dynamic Hop: Should validate conntrack entry deletion for TCP/UDP traffic via multiple external gateways a.k.a ECMP routes IPV4 tcp": "[Disabled:Unimplemented]",

	"External Gateway With Admin Policy Based External Route CRs e2e multiple external gateway stale conntrack entry deletion validation Dynamic Hop: Should validate conntrack entry deletion for TCP/UDP traffic via multiple external gateways a.k.a ECMP routes IPV4 udp": "[Disabled:Unimplemented]",

	"External Gateway With Admin Policy Based External Route CRs e2e multiple external gateway stale conntrack entry deletion validation Dynamic Hop: Should validate conntrack entry deletion for TCP/UDP traffic via multiple external gateways a.k.a ECMP routes IPV6 tcp": "[Disabled:Unimplemented]",

	"External Gateway With Admin Policy Based External Route CRs e2e multiple external gateway stale conntrack entry deletion validation Dynamic Hop: Should validate conntrack entry deletion for TCP/UDP traffic via multiple external gateways a.k.a ECMP routes IPV6 udp": "[Disabled:Unimplemented]",
	...
	"External Gateway With annotations e2e multiple external gateway stale conntrack entry deletion validation ExternalGWPod annotation: Should validate conntrack entry deletion for TCP/UDP traffic via multiple external gateways a.k.a ECMP routes IPV4 tcp": "[Disabled:Unimplemented]",
	...
	"External Gateway With annotations e2e multiple external gateway stale conntrack entry deletion validation ExternalGWPod annotation: Should validate conntrack entry deletion for TCP/UDP traffic via multiple external gateways a.k.a ECMP routes IPV4 udp": "[Disabled:Unimplemented]",
	...
	"External Gateway With annotations e2e multiple external gateway stale conntrack entry deletion validation ExternalGWPod annotation: Should validate conntrack entry deletion for TCP/UDP traffic via multiple external gateways a.k.a ECMP routes IPV6 tcp": "[Disabled:Unimplemented]",

	"External Gateway With annotations e2e multiple external gateway stale conntrack entry deletion validation ExternalGWPod annotation: Should validate conntrack entry deletion for TCP/UDP traffic via multiple external gateways a.k.a ECMP routes IPV6 udp": "[Disabled:Unimplemented]",
	...
	"Kubevirt Virtual Machines with default pod network when live migration with post-copy succeeds, should keep connectivity": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with default pod network when live migration with pre-copy fails, should keep connectivity": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with default pod network when live migration with pre-copy succeeds, should keep connectivity": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with kubevirt VM using layer2 UDPN should configure IPv4 and IPv6 using DHCP and NDP": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration failed of VirtualMachineInstance with Secondary/Localnet with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration failed of VirtualMachineInstance with interface binding for UDN with Primary/Layer2 with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachine with Secondary/Layer2 with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachine with Secondary/Localnet with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachine with interface binding for UDN with Primary/Layer2 with \"routed\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachine with interface binding for UDN with Primary/Layer2 with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachineInstance with Secondary/Layer2 with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachineInstance with Secondary/Localnet with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachineInstance with interface binding for UDN with Primary/Layer2 with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after restart of VirtualMachine with Secondary/Layer2 with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after restart of VirtualMachine with Secondary/Localnet with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after restart of VirtualMachine with interface binding for UDN with Primary/Layer2 with \"snat\" ingress": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks with ipamless localnet topology should maintain tcp connection with minimal downtime after failed live migration": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks with ipamless localnet topology should maintain tcp connection with minimal downtime after succeeded live migration": "[Skipped:Disconnected][Skipped:NoOptionalCapabilities][Skipped:Proxy][Skipped:SingleReplicaTopology][Skipped:alibabacloud][Skipped:aws][Skipped:azure][Skipped:gce][Skipped:ibmcloud][Skipped:ibmroks][Skipped:kubevirt][Skipped:nutanix][Skipped:openstack][Skipped:ovirt][Skipped:vsphere][Virtualization][Suite:openshift/network/virtualization]",
	...
	"Network Segmentation a user defined primary network with multicast feature enabled for namespace should be able to receive multicast IGMP query with primary layer2 UDN": "[Disabled:Unimplemented]",
	...
	"blocking ICMP needs frag when a client VM pod with 1500 MTU targets a host networked pod should be able to send large TCP packet and not get a route cache entry": "[Suite:openshift/conformance/parallel]",

	"blocking ICMP needs frag when a client host networked pod with targets a proxy node nodeport service with ovnk networked backend should be able to send large UDP packet and not get a route cache entry": "[Suite:openshift/conformance/parallel]",

	"blocking ICMP needs frag when an ovnk pod targets a host networked pod with large UDP should be able to send large UDP packet and not get a route cache entry": "[Suite:openshift/conformance/parallel]",
	...
	"e2e NetworkQoS validation Limits egress traffic targeting a pod by protocol and port through a NetworkQoS spec ipv4": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Limits egress traffic targeting a pod by protocol and port through a NetworkQoS spec ipv6": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Limits egress traffic targeting an individual pod by protocol through a NetworkQoS spec ipv4": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Limits egress traffic targeting an individual pod by protocol through a NetworkQoS spec ipv6": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Limits egress traffic to all target pods below the specified rate in NetworkQoS spec ipv4": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Limits egress traffic to all target pods below the specified rate in NetworkQoS spec ipv6": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Should have correct DSCP value for host network traffic when NetworkQoS is applied ipv4": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Should have correct DSCP value for host network traffic when NetworkQoS is applied ipv6": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Should have correct DSCP value for overlay traffic when NetworkQoS is applied ipv4": "[Suite:openshift/conformance/parallel]",

	"e2e NetworkQoS validation Should have correct DSCP value for overlay traffic when NetworkQoS is applied ipv6": "[Suite:openshift/conformance/parallel]",
