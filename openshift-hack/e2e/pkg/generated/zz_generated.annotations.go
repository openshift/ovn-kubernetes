...
var Annotations = map[string]string{
	...
	"e2e br-int flow monitoring export validation Should validate flow data of br-int is sent to an external gateway with sflow": "[Suite:openshift/conformance/parallel]",

	"e2e control plane should provide Internet connection continuously when all ovnkube-control-plane pods are killed": "[Suite:openshift/conformance/parallel]",

	"e2e control plane should provide Internet connection continuously when all pods are killed on node running master instance of ovnkube-control-plane": "[Suite:openshift/conformance/parallel]",

	"e2e control plane should provide Internet connection continuously when ovnkube-node pod is killed": "[Suite:openshift/conformance/parallel]",

	"e2e control plane should provide Internet connection continuously when pod running master instance of ovnkube-control-plane is killed": "[Suite:openshift/conformance/parallel]",

	"e2e control plane should provide connection to external host by DNS name from a pod": "[Suite:openshift/conformance/parallel]",

	"e2e control plane test node readiness according to its defaults interface MTU size should get node not ready with a too small MTU": "[Suite:openshift/conformance/parallel]",

	"e2e control plane test node readiness according to its defaults interface MTU size should get node ready with a big enough MTU": "[Suite:openshift/conformance/parallel]",

	"e2e delete databases Should validate connectivity before and after deleting all the db-pods at once in HA mode": "[Suite:openshift/conformance/parallel]",

	"e2e delete databases Should validate connectivity before and after deleting all the db-pods at once in Non-HA mode": "[Suite:openshift/conformance/parallel]",

	"e2e delete databases recovering from deleting db files while maintaining connectivity when deleting both db files on ovnkube-db-0": "[Suite:openshift/conformance/parallel]",

	"e2e delete databases recovering from deleting db files while maintaining connectivity when deleting both db files on ovnkube-db-1": "[Suite:openshift/conformance/parallel]",

	"e2e delete databases recovering from deleting db files while maintaining connectivity when deleting both db files on ovnkube-db-2": "[Suite:openshift/conformance/parallel]",

	"e2e ingress to host-networked pods traffic validation Validating ingress traffic to Host Networked pods with externalTrafficPolicy=local Should be allowed to node local host-networked endpoints by nodeport services": "[Suite:openshift/conformance/parallel]",

	"e2e ingress traffic validation Validating ingress traffic Should be allowed by externalip services": "[Suite:openshift/conformance/parallel]",

	"e2e ingress traffic validation Validating ingress traffic Should be allowed by nodeport services after upgrade to DualStack": "[Suite:openshift/conformance/parallel]",

	"e2e ingress traffic validation Validating ingress traffic Should be allowed by nodeport services": "[Suite:openshift/conformance/parallel]",

	"e2e ingress traffic validation Validating ingress traffic Should be allowed to node local cluster-networked endpoints by nodeport services with externalTrafficPolicy=local": "[Suite:openshift/conformance/parallel]",

	"e2e ingress traffic validation Validating ingress traffic to manually added node IPs Should be allowed by externalip services to a new node ip": "[Suite:openshift/conformance/parallel]",
	...
	"test e2e inter-node connectivity between worker nodes Should validate connectivity within a namespace of pods on separate nodes": "[Suite:openshift/conformance/parallel]",

	"test e2e pod connectivity to host addresses Should validate connectivity from a pod to a non-node host address on same node": "[Suite:openshift/conformance/parallel]",
}
