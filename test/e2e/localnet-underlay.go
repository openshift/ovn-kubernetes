...
func setupUnderlayForSecondaryBridge(ovsPods []v1.Pod, portName string, nadConfig networkAttachmentConfig) error {
...
func setupUnderlayForDefaultBridge(ovsPods []v1.Pod, nadConfig networkAttachmentConfig) error {
	for _, ovsPod := range ovsPods {
...
func teardownUnderlaySecondaryBridge(ovsPods []v1.Pod) error {
	for _, ovsPod := range ovsPods {
