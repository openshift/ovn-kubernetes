...
# TODO: Source or define these variables
# source ~/dev-scripts-additional-config
# You need to define:
# - EXTRA_NETWORK_NAMES (optional, for multi-network setups)
# - <NETWORK_NAME>_NETWORK_SUBNET_V4 (if using extra networks)
# - <NETWORK_NAME>_NETWORK_SUBNET_V6 (if using extra networks)
...
deploy_frr_external_container() {
  ...
  $CLI run -d --rm --privileged --ulimit core=-1 --network ostestbm_net --name frr --volume "$frr_config":/etc/frr quay.io/frrouting/frr:10.4.1
