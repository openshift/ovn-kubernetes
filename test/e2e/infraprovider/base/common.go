...
type ContainerOps struct {
	// Engine is the container engine (docker/podman) that commands are executed against.
...
func (o *ContainerOps) GetContainersAttachedToNetwork(networkName string) ([]string, error) {
	...
	var result []containerengine.NetworkInspect
...
func (o *ContainerOps) GetNetworkInterface(containerName, networkName string) (api.NetworkInterface, error) {
	...
	var inspectResult []containerengine.ContainerInspect
...
func (o *ContainerOps) GetNetwork(networkName string) (containerengine.Network, error) {
	n := containerengine.Network{NetName: networkName}
	exists, err := o.NetworkExists(networkName)
	if err != nil {
