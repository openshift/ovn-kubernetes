...
class ReportGenerator:
    ...
    def generate_report(self, pod_latency: Dict[str, Any], ovn_cpu: Dict[str, Any], 
        ...
        report_lines.append("## 💻 OVN Container-Level Resource Usage")
        ...
        if ovn_cpu:
            ...
            report_lines.append("### CPU Usage Summary")
            report_lines.append("⚠️ No OVN container CPU data available")
        report_lines.append("")
        ...
        if ovn_memory:
            ...
            report_lines.append("### Memory Usage Summary")
            report_lines.append("⚠️ No OVN container memory data available")
