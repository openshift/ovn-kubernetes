...
set_default_params() {
  ...
  KIND_LOCAL_REGISTRY=${KIND_LOCAL_REGISTRY_NAME:-kind-registry}
  KIND_LOCAL_REGISTRY=${KIND_LOCAL_REGISTRY_PORT:-5000}
...
build_ovn_image() {
  if [ "$OVN_IMAGE" == local ]; then
    ...
    OVN_COMMIT=1f5aad29cdf07b3b57cc986d712c809918d25721
