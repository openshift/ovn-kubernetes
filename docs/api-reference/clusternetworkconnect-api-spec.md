...
| `spec` _[ClusterNetworkConnectSpec](#clusternetworkconnectspec)_ |  |  | Required: \{\} <br />Required: \{\} <br /> |
| `status` _[ClusterNetworkConnectStatus](#clusternetworkconnectstatus)_ |  |  | Optional: \{\} <br /> |
