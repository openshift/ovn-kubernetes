...
var AppendedAnnotations = map[string]string{
	...
	"Kubevirt Virtual Machines IP family validation for layer2 primary networks should fail when dual-stack network requests only IPv4": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines IP family validation for layer2 primary networks should fail when dual-stack network requests only IPv6": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines IP family validation for layer2 primary networks should fail when single-stack IPv4 network requests multiple IPv4 IPs": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines IP family validation for layer2 primary networks should fail when single-stack IPv6 network requests multiple IPv6 IPs": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines IP family validation for layer2 primary networks should succeed when dual-stack network requests correct IPs (1 IPv4 + 1 IPv6)": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines duplicate addresses validation should fail when creating second VM with duplicate static IP": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines duplicate addresses validation should fail when creating second VM with duplicate user requested MAC": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines ipv4 subnet exhaustion should fail when subnet is exhausted": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][Suite:openshift/network/virtualization]",
	...
	"Kubevirt Virtual Machines with kubevirt VM using layer2 UDPN should configure IPv4 and IPv6 using DHCP and NDP": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][Suite:openshift/network/virtualization]",
	...
	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration failed of VirtualMachineInstance with Secondary/Localnet ingress snat": "[Disabled:Unsupported][Serial][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration failed of VirtualMachineInstance with interface binding for UDN with Primary/Layer2 ingress snat": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachine with Secondary/Layer2 ingress snat": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachine with Secondary/Localnet ingress snat": "[Disabled:Unsupported][Serial][Suite:openshift/network/virtualization]",
	...
	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachine with interface binding for UDN and statics IPs and MAC with Primary/Layer2 ingress snat": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",
	...
	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachine with interface binding for UDN with Primary/Layer2 ingress snat": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachineInstance with Secondary/Layer2 ingress snat": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after live migration of VirtualMachineInstance with Secondary/Localnet ingress snat": "[Disabled:Unsupported][Serial][Suite:openshift/network/virtualization]",
	...
	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after restart of VirtualMachine with Secondary/Layer2 ingress snat": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after restart of VirtualMachine with Secondary/Localnet ingress snat": "[Disabled:Unsupported][Serial][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after restart of VirtualMachine with interface binding for UDN and statics IPs and MAC with Primary/Layer2 ingress snat": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][OCPFeatureGate:PreconfiguredUDNAddresses][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks and persistent ips configured should keep ip after restart of VirtualMachine with interface binding for UDN with Primary/Layer2 ingress snat": "[OCPFeatureGate:NetworkSegmentation][OCPFeatureGate:PersistentIPsForVirtualization][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks with ipamless localnet topology should maintain tcp connection with minimal downtime after failed live migration": "[OCPFeatureGate:NetworkSegmentation][Serial][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks with ipamless localnet topology should maintain tcp connection with minimal downtime after succeeded live migration": "[OCPFeatureGate:NetworkSegmentation][Serial][Suite:openshift/network/virtualization]",

	"Kubevirt Virtual Machines with user defined networks with ipamless localnet topology should start multiple VMs with same hostname": "[OCPFeatureGate:NetworkSegmentation][Serial][Suite:openshift/network/virtualization]",
