...
var AppendedAnnotations = map[string]string{
	...
	"Load Balancer Service Tests with MetalLB Should ensure load balancer service works without node ports when ETP=local": "[Suite:openshift/conformance/parallel]",

	"Load Balancer Service Tests with MetalLB Should ensure load balancer service works without node ports when named targetPorts are used and ETP=local": "[Suite:openshift/conformance/parallel]",
