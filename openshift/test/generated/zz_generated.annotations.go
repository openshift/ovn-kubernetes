...
var AppendedAnnotations = map[string]string{
	...
	"Network Segmentation Sync perform east/west traffic between nodes following OVN Kube node pod restart L2 with custom network": "[Suite:ovn-kubernetes/conformance/parallel]",

	"Network Segmentation Sync perform east/west traffic between nodes following OVN Kube node pod restart L2": "[Suite:ovn-kubernetes/conformance/parallel]",

	"Network Segmentation Sync perform east/west traffic between nodes following OVN Kube node pod restart L3": "[Suite:ovn-kubernetes/conformance/parallel]",
	...
	"Network Segmentation: Default network multus annotation when added with static IP and MAC to a pod belonging to primary UDN should create the pod with the specified static IP and MAC address": "[Suite:ovn-kubernetes/conformance/parallel]",
	...
	"e2e egress IP validation Cluster Default Network [secondary-host-eip] Egress IP Traffic Leak Prevention with Packet Mark Validation Should prevent pod IP traffic leak when EgressIP on secondary interface is applied to existing running pods": "[Disabled:Unimplemented]",
	...
	"e2e egress IP validation Network Segmentation: IPv4 L2 role primary [secondary-host-eip] Egress IP Traffic Leak Prevention with Packet Mark Validation Should prevent pod IP traffic leak when EgressIP on secondary interface is applied to existing running pods": "[Disabled:Unimplemented]",
	...
	"e2e egress IP validation Network Segmentation: IPv4 L3 role primary [secondary-host-eip] Egress IP Traffic Leak Prevention with Packet Mark Validation Should prevent pod IP traffic leak when EgressIP on secondary interface is applied to existing running pods": "[Disabled:Unimplemented]",
	...
	"e2e egress IP validation Network Segmentation: IPv6 L2 role primary [secondary-host-eip] Egress IP Traffic Leak Prevention with Packet Mark Validation Should prevent pod IP traffic leak when EgressIP on secondary interface is applied to existing running pods": "[Disabled:Unimplemented]",
	...
	"e2e egress IP validation Network Segmentation: IPv6 L3 role primary [secondary-host-eip] Egress IP Traffic Leak Prevention with Packet Mark Validation Should prevent pod IP traffic leak when EgressIP on secondary interface is applied to existing running pods": "[Disabled:Unimplemented]",
